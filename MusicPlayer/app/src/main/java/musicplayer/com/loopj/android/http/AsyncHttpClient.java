...
public class AsyncHttpClient {
    ...
    public void delete(String url, RequestParams params, AsyncHttpResponseHandler responseHandler) {
        ...
        sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpDelete(URI.create(url).normalize()), paramsToEntity(params, responseHandler)), null, responseHandler, null);
    }
